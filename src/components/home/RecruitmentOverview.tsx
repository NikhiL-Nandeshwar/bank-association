            ...
            <div className="mx-auto max-w-7xl px-4 grid grid-cols-1 gap-8 md:grid-cols-4">
                ...
                <div className="md:col-span-3 bg-white rounded-xl shadow-sm">
                    ...
                    <div className="flex border-b">
                        <button className="px-6 py-3 text-sm bg-blue-950 text-yellow-400 font-semibold border-b-2 border-yellow-600">
                                ...
                                {currentRecruitments.map((item) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 text-center">
                                            <Link
                                                href="/recruitment"
                                                className="inline-block rounded-md bg-yellow-400 px-4 py-1.5 text-xs font-semibold text-gray-800 hover:bg-yellow-500"
                                            >
                                                Apply Now
                                            </Link>
                                        </td>
