...
export const PREVIOUS_RECRUITMENTS = [
  {
    ...
    time: '10:00 AM',
    status: 'Closed',
    resultDate: '30-09-2025',
    position: 'Clerk',
    totalSelected: 4,
    candidates: [
      { rollNo: 'KM012-1042', name: 'Aditi Patil', category: 'Open', marks: 82 },
      { rollNo: 'KM012-1086', name: 'Nikhil Vaidya', category: 'Open', marks: 79 },
      { rollNo: 'KM012-1134', name: 'Sourabh Sardesai', category: 'Open', marks: 77 },
      { rollNo: 'KM012-1191', name: 'Medhali Jadhav', category: 'SC', marks: 74 },
    ],
  },
  {
    code: 'KM-011',
    ...
    resultDate: '12-08-2025',
    position: 'Junior Officer',
    totalSelected: 5,
    candidates: [
      { rollNo: 'KM011-2031', name: 'Pranav Kulkarni', category: 'Open', marks: 86 },
      { rollNo: 'KM011-2078', name: 'Meera Deshmukh', category: 'Open', marks: 84 },
      { rollNo: 'KM011-2112', name: 'Kiran More', category: 'OBC', marks: 81 },
      { rollNo: 'KM011-2160', name: 'Vaishnavi Kadam', category: 'EWS', marks: 78 },
      { rollNo: 'KM011-2215', name: 'Sagar Mane', category: 'SC', marks: 75 },
    ],
  },
  {
    code: 'KM-010',
    ...
    totalSelected: 3,
    candidates: [
      { rollNo: 'KM010-3018', name: 'Omkar Salunkhe', category: 'Open', marks: 80 },
      { rollNo: 'KM010-3064', name: 'Rutuja Chavan', category: 'OBC', marks: 76 },
      { rollNo: 'KM010-3099', name: 'Aniket Lokhande', category: 'NT', marks: 72 },
    ],
  },
] as const;
