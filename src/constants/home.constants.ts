...
export const ASSOCIATION_COMMITMENT_COPY = {
  en: {
    ...
    description:
      'Kolhapur Zilla Nagari Banks Sahakari Association Ltd. helps member institutions with planning, training, and implementation support so they can build stronger, more people-focused banking operations.',
    focusAreas: [
      {
